...
<title>Selecionar conta — <?= APP_NAME ?></title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .tenant-btn:hover { background: #6366f1; color: #fff; border-color: #6366f1; }
...
<div class="card">
  ...
  <form method="POST">
    ...
    <button type="submit" class="tenant-btn">
      <span class="dot" style="background:<?= e($t['brand_color'] ?: '#6366f1') ?>"></span>
